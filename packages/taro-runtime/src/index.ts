...
export {
  ...
  createPageConfig,
  createQkdivCompConfig,
  createQkimageCompConfig,
  createQklistCompConfig,
  createQklistitemCompConfig,
  createQkspanCompConfig,
  createQktextareaCompConfig,
  createQktextCompConfig,
  createQkvideoCompConfig,
  createQktabsCompConfig,
  createQktabbarCompConfig,
  createQktabcontentCompConfig,
